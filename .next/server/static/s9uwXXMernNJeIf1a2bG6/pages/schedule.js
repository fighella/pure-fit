...
module.exports = __webpack_require__("Dkr4");
...
// CONCATENATED MODULE: ./components/ScheduleWrapper.js
...
var Hero_Hero = function Hero(props) {
  ...
  var bottomFade = faded ? external_react_default.a.createElement(BottomFade, null) : false;
  var spaced = compact ? false : external_react_default.a.createElement(VerticalSpacing, null);
  var closeButton = close ? external_react_default.a.createElement(CloseButton, {
    onClick: function onClick() {
      return router_default.a.Back();
    }
  }, "X") : false;
  return external_react_default.a.createElement(external_react_default.a.Fragment, null, external_react_default.a.createElement(external_react_measure_default.a, {
    bounds: true,
    onResize: function onResize(contentRect) {
      setDimensions(contentRect.bounds);
    }
    ...
    var measureRef = _ref.measureRef;
    return external_react_default.a.createElement(HeroComponent, {
      ref: measureRef,
      width: dimensions.width,
      imgs: custom_imgs ? custom_imgs[0] : 'https://s3.amazonaws.com/pureyogaottawa.com/website/team-photos/' + imgs[0] + '.jpg',
      compact: compact
    }, closeButton, external_react_default.a.createElement(HeroPosition, {
      compact: compact
    }, external_react_default.a.createElement(HeroTitle, {
      compact: compact,
      width: dimensions.width
    }, props.title.split('with')[0]), external_react_default.a.createElement(HeroSubTitle, null, subtitle)), bottomFade);
  }), spaced);
};
...
var BottomFade = external_styled_components_default.a.div.withConfig({
...
var FlexCenterCol = external_styled_components_default.a.div.withConfig({
  displayName: "Hero__FlexCenterCol",
  componentId: "sc-1g40rlq-1"
})(["display:flex;align-items:center;text-align:center;"]);
var HeroComponent = external_styled_components_default()(FlexCenterCol).withConfig({
...
var VerticalSpacing = external_styled_components_default.a.div.withConfig({
...
var CenterDiv = external_styled_components_default.a.div.withConfig({
  displayName: "Hero__CenterDiv",
  componentId: "sc-1g40rlq-4"
})(["text-align:center;margin:0 auto;"]);
var HeroPosition = external_styled_components_default()(CenterDiv).withConfig({
...
var HeroSubTitle = external_styled_components_default.a.div.withConfig({
...
// CONCATENATED MODULE: ./components/schedule/Page.jsx
...
var Page_ref = [config["a" /* EvolveConfig */].style],
    style = Page_ref[0];
var zone = 'Etc/GMT';
var schedules = [{
...
var startDate = external_moment_timezone_default.a.tz(new Date(), zone);
...
var ScheduleWrapped = ScheduleWrapper(Schedule["a" /* Schedule */], utils_src["a" /* default */]);

var Page_SchedulePage =
/*#__PURE__*/
function (_Component) {
  Object(inherits["a" /* default */])(SchedulePage, _Component);

  function SchedulePage(props) {
    var _this;

    Object(classCallCheck["a" /* default */])(this, SchedulePage);

    _this = Object(possibleConstructorReturn["a" /* default */])(this, Object(getPrototypeOf["a" /* default */])(SchedulePage).call(this, props));

    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this)), "thisLocation", function (e) {
      return _this.state.location === 'All Locations' || e.location === _this.state.location && _this.state.day !== 1000;
    });

    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this)), "thisDay", function (e) {
      return _this.state.dayText === 'Today' || e.day === _this.state.day;
    });

    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this)), "selectDropdown", function (event) {
      _this.setState({
        location: event.target.innerText
      });
    });

    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this)), "selectDayDropdown", function (event) {
      _this.setState({
    ...
    _this.dayToggle = _this.dayToggle.bind(Object(assertThisInitialized["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this)));
    _this.state = {
      classes: [],
      ...
      dropdownOpen: false,
      day: external_moment_timezone_default()(new Date(), zone).format('YYYY-MM-DD'),
      days: 1,
      dayText: 'Today',
  ...
  Object(createClass["a" /* default */])(SchedulePage, [{
    key: "toggle",
    ...
    value: function render() {
      ...
      var schedule_columns = schedules.filter(this.thisLocation).map(function (schedule) {
        ...
        }, external_react_default.a.createElement(ScheduleWrapped, {
      ...
      var datePicker = dateFilters.map(function (df) {
        return external_react_default.a.createElement(external_reactstrap_["DropdownItem"], {
          key: df.dayText,
      ...
      return external_react_default.a.createElement("div", {
        style: style.body
      }, external_react_default.a.createElement(components_Hero, {
        imgs: ['team_126'],
        title: 'Practice',
      ...
      }, external_react_default.a.createElement(LocationSelector, null, external_react_default.a.createElement(external_reactstrap_["Dropdown"], {
        size: "lg",
        isOpen: this.state.dropdownOpen,
        toggle: this.toggle
      }, external_react_default.a.createElement(external_reactstrap_["DropdownToggle"], {
        caret: true
      }, this.state.location), external_react_default.a.createElement(external_reactstrap_["DropdownMenu"], null, external_react_default.a.createElement(external_reactstrap_["DropdownItem"], {
        onClick: this.selectDropdown
      }, "All Locations"), external_react_default.a.createElement(external_reactstrap_["DropdownItem"], {
        onClick: this.selectDropdown
      }, "Pure Yoga Westboro"), external_react_default.a.createElement(external_reactstrap_["DropdownItem"], {
        onClick: this.selectDropdown
      }, "Pure Yoga Centretown"), external_react_default.a.createElement(external_reactstrap_["DropdownItem"], {
        onClick: this.selectDropdown
      }, "Pure Yoga Downtown")))), "\xA0", external_react_default.a.createElement(DaySelector, null, external_react_default.a.createElement(external_reactstrap_["Dropdown"], {
        size: "lg",
        isOpen: this.state.dayDropdownOpen,
        toggle: this.dayToggle
      }, external_react_default.a.createElement(external_reactstrap_["DropdownToggle"], {
        caret: true
      }, this.state.dayText), external_react_default.a.createElement(external_reactstrap_["DropdownMenu"], null, datePicker)))), external_react_default.a.createElement("div", {
        id: "schedule",
        style: {
          zIndex: 100,
          position: 'relative'
        ...
        fluid: true
      }, external_react_default.a.createElement(external_reactstrap_["Row"], null, schedule_columns)), external_react_default.a.createElement(FootNote, null, content["a" /* AppContent */].footnote)), external_react_default.a.createElement(AppDownload["a" /* AppDownload */], null), external_react_default.a.createElement(Strap, null, external_react_default.a.createElement(Title, null, "Centretown, Downtown & Westboro"), external_react_default.a.createElement(SubTitle, null, content["a" /* AppContent */].new_to_yoga_strap_subtitle), external_react_default.a.createElement("br", null), external_react_default.a.createElement("p", {
        style: {
          lineHeight: '2em'
        }
...
var LocationSelector = external_styled_components_default.a.div.withConfig({
...
var DaySelector = external_styled_components_default.a.div.withConfig({
...
})(["", ";font-size:2em;font-weight:450;"], variables["c" /* fonts */].primary);
var SubTitle = external_styled_components_default.a.h3.withConfig({
  displayName: "Page__SubTitle",
  componentId: "yitr3v-5"
})(["", ";font-size:1.4em;"], variables["c" /* fonts */].highlight);
/* harmony default export */ var Page = (Page_SchedulePage);
// EXTERNAL MODULE: ./styles/custom.scss
var custom = __webpack_require__("b8oL");

// CONCATENATED MODULE: ./pages/schedule.jsx




/* harmony default export */ var pages_schedule = __webpack_exports__["default"] = (function () {
  return external_react_default.a.createElement(Layout["a" /* default */], null, external_react_default.a.createElement(Page, null));
});
